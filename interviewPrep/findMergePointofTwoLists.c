...
int findMergeNode(SinglyLinkedListNode* head1, SinglyLinkedListNode* head2) {
	struct SinglyLinkedListNode* slow;			
	struct SinglyLinkedListNode* fast;			
	struct SinglyLinkedListNode* curr;			
	...
	prev->next = head1;
	printf("h1 head: %d", head1->data);
	printf("h1 tail: %d", prev->data);
